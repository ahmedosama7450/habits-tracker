      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <Card className="p-8 bg-white shadow-lg">
          <div className="text-center space-y-6">
            ...
            {/* App Logo/Icon - Using a simple green circle for now */}
            ...
            <div className="space-y-4">
              <Button
                ...
                disabled={isLoading}
                className="w-full bg-white hover:bg-gray-50 text-gray-900 border border-gray-300 shadow-sm disabled:opacity-50"
                size="lg"
              >
