...
1. **Add a Habit**: Click the "Add Habit" button to create a new habit with your preferred schedule
2. **Track Progress**: Navigate through months and check off completed habits
3. **Edit Habits**: Use the dropdown menu on habit cards to edit or delete habits
4. **Settings**: Configure language preference and first tracking month
